  ...
  return (
    <div className="min-h-screen bg-background text-foreground p-6">
      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-[320px_1fr] gap-4">
        <div className="border border-border rounded-xl p-2 bg-card max-h-[75vh] overflow-y-auto">
        ...
        <div className="border border-border rounded-xl p-4 bg-card space-y-3 min-h-[75vh]">
          {!selected ? (
            ...
            <>
              ...
              <div>
                ...
                <textarea
                  className="w-full min-h-[380px] rounded-md border border-border bg-background p-3 text-sm font-mono"
                  value={draft.content}
